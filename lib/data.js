...
export const features = [
  ...
  {
    icon: <Video className="h-16 w-16 text-emerald-400" />,
  ...
  {
    icon: <CreditCard className="h-16 w-16 text-emerald-400" />,
  ...
  {
    icon: <ShieldCheck className="h-16 w-16 text-emerald-400" />,
  ...
  {
    icon: <FileText className="h-16 w-16 text-emerald-400" />,
